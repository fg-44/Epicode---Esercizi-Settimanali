...
*/
if (crewMass < 500) console.log("Ship is underloaded");
...
/* --EXTRA-- ESERCIZIO 9 -NON FINITO IN GIORNATA
...
characters.forEach(character => {
  ...
  if (femaleCharacters.includes(character.name)) {
...
/* --EXTRA-- ESERCIZIO 10 -NON FINITO IN GIORNATA
  Crea una funzionalità che selezioni un elemento casuale dall'array "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
*/

let randomChar = starWarsCharacters[Math.floor(Math.random() * starWarsCharacters.length)];

console.log("Name: " + randomChar.name);
console.log("Height: " + randomChar.height);
console.log("Mass: " + randomChar.mass);
console.log("Gender: " + randomChar.gender);
console.log("Birth year: " + randomChar.birth_year);
